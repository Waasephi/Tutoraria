...
namespace Tutoraria.Items
{
	public class CrimsonAltar : ModItem
	{
		public override void SetStaticDefaults() 
		{
            ...
            Tooltip.SetDefault("This is just a place holder item since this item doesnt have an actual item. It can be found in the crimson or randomly in the world.");
		}
