...
namespace Tutoraria.Items
{
	public class DemonAltar : ModItem
	{
		public override void SetStaticDefaults() 
		{
            ...
            Tooltip.SetDefault("This is just a place holder item since this item doesnt have an actual item. It can be found in the corruption or randomly in the world.");
		}
